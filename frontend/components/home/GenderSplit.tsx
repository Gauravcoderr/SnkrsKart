...
export default function GenderSplit() {
  ...
  return (
    <section className="w-full overflow-hidden">
      ...
      {/* ── Desktop: two equal columns side-by-side with divider ── */}
        ...
        {PANELS.map((panel, idx) => {
          ...
          return (
            ...
            >
              ...
              {/* Vertical divider — right edge of Men panel only */}
              {idx === 0 && (
              ...
              {/* Content */}
              <div className={`absolute bottom-10 flex flex-col ${panel.align === 'left' ? 'left-10 sm:left-14 right-6' : 'right-10 sm:right-14 left-6'}`}>
                <p
